...
{
    public enum JOB_NOTIFY_FIELD : UInt16
    { 
        ...
        [Obsolete] JOB_NOTIFY_FIELD_SECURITY_DESCRIPTOR         = 0x0C, // Not supported
        ...
        [Obsolete] JOB_NOTIFY_FIELD_REMOTE_JOB_ID               = 0x18, // Not documented
    }
}